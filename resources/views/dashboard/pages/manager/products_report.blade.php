                    ...
                    <table class="w-100 data-table">
                        <thead>
                            <tr class="heading-row">
                                ...
                                <th class="heading-column">Total Sale</th>
                                <th class="heading-column">Items Sold</th>
                                <th class="heading-column">Total Waste</th>
                                <th class="heading-column">Items Wasted</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $recipe->recipe_name }}</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $recipe->total_sale }}</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $recipe->sale_count }} pcs</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $recipe->total_waste }} TK</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $recipe->waste_count }} pcs</h3>
                                        </div>
                                    </div>
                                </td>
                            </tr>
