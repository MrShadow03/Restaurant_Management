@section('title')
    @if ($report_type == 'daily')
        <title>Daily Sales Report - {{ isset($date) ? $date : date('M d, Y') }}</title>
    @elseif ($report_type == 'monthly')
        <title>Monthly Sales Report -
            {{ isset($month) ? Carbon\Carbon::createFromFormat('m', $month)->monthName.'-'.date('Y') : date('F, Y') }}</title>
    @elseif ($report_type == 'yearly')
        <title>Yearly Sales Report - {{ isset($year) ? $year : date('Y') }}</title>
    @endif
@endsection
                    ...
                    <table class="w-100 data-table">
                        <thead>
                            <tr class="heading-row">
                                ...
                                <th class="heading-column">Discount</th>
                                <th class="heading-column">Sale</th>
                                <th class="heading-column">Served By</th>
                                <th class="heading-column">Invoice</th>
                        ...
                        <tbody>
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $sale->recipe_name }}</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $sale->quantity }}</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $sale->discount }}</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $sale->price * $sale->quantity }} TK</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $sale->username }}</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title">{{ $sale->invoice->invoice_number }}</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 data-sort="{{ Carbon\Carbon::parse($sale->created_at)->format('Y-m-d') }}"
                                                class="table-column__title">
                                                {{ Carbon\Carbon::parse($sale->created_at)->format('M d, Y') }}</h3>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                @php
                                    $total += ($sale->price - ($sale->discount/100)) * $sale->quantity;
                                    $index++;
                                @endphp
                            @endforeach
                            <tr>
                                <td class="table-column text-white">{{ $index+1 }}</td>
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                ...
                                <td class="table-column">
                                    <div class="table-column__wrapper">
                                        <div class="table-column__content">
                                            <h3 class="table-column__title text-orange fs-16 fw-600">{{ $total }} TK</h3>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-column">---</td>
