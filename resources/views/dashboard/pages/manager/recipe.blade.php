                    ...
                    <table class="w-100 data-table">
                        <thead>
                            <tr class="heading-row">
                                ...
                                <th class="heading-column">Added</th>
                                    ...
                                    <td class="table-column">
                                        <div class="table-column__wrapper">
                                            ...
                                            <div class="table-column__content">
                                                ...
                                                <p class="table-column__subtitle">{{ $recipe->price }} BDT</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="table-column">
                                        <div class="table-column__wrapper">
                                            <div class="table-column__content">
                                                <h3 class="table-column__title">{{ $recipe->created_at->diffForHumans() }}</h3>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="table-column">
                                        <div class="table-column__wrapper">
                                            <div class="table-column__content">
                                                <a href="#subtract_product_model" class="btn-sm" onclick="subtractProduct()"><i class="fa-regular fa-minus"></i></a>
                                                <a href="#add_product_modal" class="btn-sm" onclick="addProduct()"><i class="fa-regular fa-plus"></i></a>
                                                <a href="#edit_product_modal" title="Edit product" class="btn-sm" onclick="editProduct()">Edit</a>
...
<script>
    ...
    tomSelect = new TomSelect('#category', {
        create: true,
        maxItems: 1,
        valueField: 'id',
        labelField: 'name',
